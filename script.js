...
// con.setAttribute('onsubmit','validate()')
...
s3.innerText="Chapathi"
flex.appendChild(ch3)
flex.appendChild(s3)
ch3.setAttribute('type','checkbox')
ch3.setAttribute('value','Chapathi')
...
s4.innerText="Gobi Manchuriya"
flex.appendChild(ch4)
flex.appendChild(s4)
ch4.setAttribute('type','checkbox')
ch4.setAttribute('value','Gobi Manchuriya')
...
ch5.setAttribute('value','Dosa')
choice.appendChild(flex)

// let ch6=document.createElement('input')
// let s6=document.createElement('span')
// s6.classList.add("p-2")
// s6.innerText="vada"
// flex.appendChild(ch6)
// flex.appendChild(s6)
// ch6.setAttribute('type','checkbox')
// ch6.setAttribute('id','v5')
// ch6.setAttribute('value','Vada')
// choice.appendChild(flex)
...
btn.classList.add("btn","btn-warning","my-4")
...
r_btn.classList.add("btn","btn-primary","my-4","mx-4")
